...
type PerformerFunction<'a> = Box<dyn Fn(Arc<Mutex<SchnapsenDuo>>, Rc<RefCell<schnapsen_rs::models::Player>>, SchnapsenDuoActions) -> Result<(), PerformerError> + Send + Sync + 'a>;
...
impl<'a> Performer<'a>
{
    pub fn new(player_id: String, instance: Arc<Mutex<SchnapsenDuo>>) -> Self {
        ...
        functions.insert(SchnapsenDuoEmptyActions::PlayCard, Box::new(Self::play_card) as PerformerFunction<'a>);
        functions.insert(SchnapsenDuoEmptyActions::Quit, Box::new(Self::quit) as PerformerFunction<'a>);
        functions.insert(SchnapsenDuoEmptyActions::SwapTrump, Box::new(Self::swap_trump) as PerformerFunction<'a>);
        functions.insert(SchnapsenDuoEmptyActions::CloseTalon, Box::new(Self::close_talon) as PerformerFunction<'a>);
        functions.insert(SchnapsenDuoEmptyActions::Announce20, Box::new(Self::announce_20) as PerformerFunction<'a>);
        functions.insert(SchnapsenDuoEmptyActions::Announce40, Box::new(Self::announce_40) as PerformerFunction<'a>);
        functions.insert(SchnapsenDuoEmptyActions::DrawCard, Box::new(Self::draw_card) as PerformerFunction<'a>);
        functions.insert(SchnapsenDuoEmptyActions::CuttDeck, Box::new(Self::cutt_deck) as PerformerFunction<'a>);
        functions.insert(SchnapsenDuoEmptyActions::TakeCards, Box::new(Self::take_cards) as PerformerFunction<'a>);
    ...
    fn quit(instance: Arc<Mutex<SchnapsenDuo>>, player: Rc<RefCell<schnapsen_rs::models::Player>>, action: SchnapsenDuoActions) -> Result<(), PerformerError> {
        Err(PerformerError::CallError) // TODO: Implement function
    }

    fn swap_trump(instance: Arc<Mutex<SchnapsenDuo>>, player: Rc<RefCell<schnapsen_rs::models::Player>>, action: SchnapsenDuoActions) -> Result<(), PerformerError> {
    ...
    fn close_talon(instance: Arc<Mutex<SchnapsenDuo>>, player: Rc<RefCell<schnapsen_rs::models::Player>>, action: SchnapsenDuoActions) -> Result<(), PerformerError> {
        Err(PerformerError::CallError) // TODO: Implement function
    }

    fn announce_20(instance: Arc<Mutex<SchnapsenDuo>>, player: Rc<RefCell<schnapsen_rs::models::Player>>, action: SchnapsenDuoActions) -> Result<(), PerformerError> {
        Ok(instance.lock().unwrap().announce_20(player)?)
    }

    fn announce_40(instance: Arc<Mutex<SchnapsenDuo>>, player: Rc<RefCell<schnapsen_rs::models::Player>>, action: SchnapsenDuoActions) -> Result<(), PerformerError> {
    ...
    fn take_cards(instance: Arc<Mutex<SchnapsenDuo>>, player: Rc<RefCell<schnapsen_rs::models::Player>>, action: SchnapsenDuoActions) -> Result<(), PerformerError> {
